...
let titleJsons = {};
titleJsons = { "pages/index/index": "CCST研讨室预约", "pages/index/me": "我的", "pages/buildings/buildings": "教学楼列表", "pages/classrooms/classrooms": "教室列表", "pages/apply/apply": "申请", "pages/apply/progress": "申请进度", "pages/user/login": "登录", "pages/user/my_application": "我的申请", "pages/user/user_info": "个人信息", "pages/user/all_applications": "申请审批", "pages/user/lab_mng": "实验室管理", "pages/user/user_mng": "用户管理", "pages/user/clsroom_mng": "教室管理" };
  ...
  !function(t2, e2) {
    ...
    var b = function() {
      ...
      return m2.parse = function(t3) {
        ...
        var n3 = this, r2 = !!O.u(e3) || e3, f3 = O.p(t3), l2 = function(t4, e4) {
        ...
        var n3, o3 = O.p(t3), f3 = "set" + (this.$u ? "UTC" : ""), l2 = (n3 = {}, n3[a] = f3 + "Date", n3[d] = f3 + "Date", n3[c] = f3 + "Month", n3[h] = f3 + "FullYear", n3[u] = f3 + "Hours", n3[s2] = f3 + "Minutes", n3[i] = f3 + "Seconds", n3[r] = f3 + "Milliseconds", n3)[o3], $2 = o3 === a ? this.$D + (e3 - this.$W) : e3;
        if (o3 === c || o3 === h) {
        ...
        var r2 = t3 || "YYYY-MM-DDTHH:mm:ssZ", i2 = O.z(this), s3 = this.$H, u2 = this.$m, a2 = this.$M, o3 = n3.weekdays, c2 = n3.months, f3 = n3.meridiem, h2 = function(t4, n4, i3, s4) {
    ...
    return w.prototype = _, [["$ms", r], ["$s", i], ["$m", s2], ["$H", u], ["$W", a], ["$M", c], ["$y", h], ["$D", d]].forEach(function(t3) {
      _[t3[1]] = function(e3) {
